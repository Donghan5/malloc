...
/*   Updated: 2025/11/10 19:02:05 by donghank         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)
{
	...
	ft_putstr_fd("\n--- 4. Reallocations ---\n", 1);
	ft_putstr_fd("Reallocating ptr1 to 200 bytes\n", 1);
	ptr1 = realloc(ptr1, 200);
	ft_putstr_fd("ptr1 new address: ", 1);
	print_memory_address_portable(ptr1);
	ft_putstr_fd("\n", 1);

	ft_putstr_fd("Reallocating ptr3 to 5000 bytes\n", 1);
	ptr3 = realloc(ptr3, 5000);
	ft_putstr_fd("ptr3 new address: ", 1);
	print_memory_address_portable(ptr3);	
	ft_putstr_fd("\n", 1);
	
	ft_putstr_fd("--- 4. Freeing All Remaining Pointers ---\n", 1);
	...
	print_memory_address_portable(ptr_zero);
	ft_putstr_fd("\n", 1);
	free(ptr_zero);
